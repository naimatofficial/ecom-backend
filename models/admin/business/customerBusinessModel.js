...
const customerSchema = new mongoose.Schema(
    {
        ...
        minimumPointRequiredToConvert: {
            ...
            required: [
                true,
                'Please provide the minimum points required to convert',
            ],
        },
        earningsToEachReferral: {
            ...
            required: [
                true,
                'Please provide the earnings amount for each referral',
            ],
        },
    },
    {
...
const CustomerBusiness = DbConnection.model('CustomerBusiness', customerSchema)
